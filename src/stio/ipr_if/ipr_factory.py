...
from stio.ipr.ipr_v0d1d2 import IPRv0d1d2
...
class IPRFactory(object):
    ...
    def create_ipr_by_name(version: str):
        ...
        if iv == IPRVersion.V0D0D1: return IPRv0d0d1()
        elif iv == IPRVersion.V0D1D0: return IPRV0d1d0()
        elif iv == IPRVersion.V0D1D2: return IPRv0d1d2()
        else: return None
